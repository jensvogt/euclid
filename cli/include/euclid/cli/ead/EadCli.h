...
namespace Euclid::CLI {
    ...
    /**
     * @brief Processes commands for the "ead" (Euclid audit) module (e.g. "ead list-events").
     *
     * @author jensvogt47\@gmail.com
     */
    class EadCli final : BaseCli {
      ...
      public:
         ...
         */
        explicit EadCli(std::string endpoint, Credentials::Entry authentication = {}, bool pretty = true, std::string caCertPath = {});
      ...
      private:
        ...
        /**
         * @brief One page of the audit trail, newest first.
         *
         * @param args command line arguments
         * @return ok
         */
        [[nodiscard]]
        int listEvents(const std::vector<std::string> &args) const;

        /**
         * @brief How many entries a filter matches.
         *
         * @param args command line arguments
         * @return ok
         */
        [[nodiscard]]
        int countEvents(const std::vector<std::string> &args) const;

        /**
         * @brief Removes entries older than a given age.
         *
         * @param args command line arguments
         * @return ok
         */
        [[nodiscard]]
        int purgeEvents(const std::vector<std::string> &args) const;

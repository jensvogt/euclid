...
namespace Euclid::CLI {
    ...
    public:
        ...
        /**
         * @brief Whether a topic exists, answered as an exit code a shell can branch on.
         *
         * @par
         * Written for `if euclid-cli ens exists-topic -t name; then`. 0 when it is there, 1 when it
         ...
         * @return 0 if the topic exists, 1 if it does not, 2 if the question could not be answered
         */
        [[nodiscard]]
        int existsTopic(const std::vector<std::string> &args) const;

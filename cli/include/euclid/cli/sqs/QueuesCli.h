...
#include <euclid/dto/sqs/SetMessageVisibilityRequest.h>
...
namespace Euclid::CLI {
    ...
    public:
         ...
         */
        explicit QueuesCli(std::string endpoint, Credentials::Entry authentication = {}, bool pretty = true, std::string caCertPath = {});

...
namespace Euclid::Dto::EKM {
    ...
    struct ListCertificatesRequest {
        ...
        /**
         * @brief Sorting column. "notAfter" sorts by expiry, which is what answers "what is about
         * to stop working".
         */
    ...
    private:
        ...
        friend ListCertificatesRequest tag_invoke(boost::json::value_to_tag<ListCertificatesRequest>, boost::json::value const &v) {
            ListCertificatesRequest r;
        ...
        friend void tag_invoke(boost::json::value_from_tag, boost::json::value &jv, ListCertificatesRequest const &obj) {
            jv = {
                    {"prefix", obj.prefix},

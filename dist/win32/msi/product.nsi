...
Section "Main Application" SecMain
  ...
  File "${BUILDDIR}\bin\euclid-ead.exe"
  File "${BUILDDIR}\bin\euclid-eag.exe"
  File "${BUILDDIR}\bin\euclid-eam.exe"
  File "${BUILDDIR}\bin\euclid-eap.exe"
  File "${BUILDDIR}\bin\euclid-ees.exe"
  File "${BUILDDIR}\bin\euclid-ekm.exe"
  File "${BUILDDIR}\bin\euclid-ekv.exe"
  File "${BUILDDIR}\bin\euclid-emd.exe"
  File "${BUILDDIR}\bin\euclid-emm.exe"
  File "${BUILDDIR}\bin\euclid-emo.exe"
  File "${BUILDDIR}\bin\euclid-ens.exe"
  File "${BUILDDIR}\bin\euclid-eqs.exe"
  File "${BUILDDIR}\bin\euclid-esm.exe"
  File "${BUILDDIR}\bin\euclid-ess.exe"
  File "${BUILDDIR}\bin\euclid-ets.exe"
  File "${BUILDDIR}\bin\euclid-ftp.exe"
  File "${BUILDDIR}\bin\euclid-mgr.exe"
  File "${BUILDDIR}\bin\euclid-sftp.exe"

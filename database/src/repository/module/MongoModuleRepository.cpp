...
namespace Euclid::Database {
    ...
    bool MongoModuleRepository::exists(const std::string &name) const {
    ...
    std::optional<Entity::Module> MongoModuleRepository::findById(const std::string &oid) const {
    ...
    std::optional<Entity::Module> MongoModuleRepository::findByName(const std::string &name) const {
    ...
    std::vector<Entity::Module> MongoModuleRepository::findAll() const {
    ...
    void MongoModuleRepository::upsert(const Entity::Module &module) {
    ...
    long MongoModuleRepository::count() const {
    ...
    void MongoModuleRepository::remove(const std::string &name) {
    ...
    void MongoModuleRepository::clear() {

...
namespace Euclid::Database {
    ...
    std::optional<Entity::EQS::Queue> MongoEnsRepository::findQueueByName(const std::string &name) const {
    ...
    std::optional<Entity::EQS::Queue> MongoEnsRepository::findQueueByErn(const std::string &ern) const {
    ...
    std::vector<Entity::EQS::Queue> MongoEnsRepository::listQueues(const std::string &prefix, const long pageSize, const long pageIndex, const std::string &sortColumn) const {
    ...
    Entity::EQS::Queue MongoEnsRepository::upsertQueue(Entity::EQS::Queue &queue) {
    ...
    long MongoEnsRepository::countQueues() const {
    ...
    void MongoEnsRepository::deleteQueueByErn(const std::string &ern) {
    ...
    std::optional<Entity::EQS::Message> MongoEnsRepository::findMessageById(const std::string &oid) const {
    ...
    std::vector<Entity::EQS::Message> MongoEnsRepository::listMessages(const std::string &queueErn, const long pageSize, const long pageIndex, const std::string &sortColumn) const {
    ...
    void MongoEnsRepository::upsertMessage(const Entity::EQS::Message &message) {
    ...
    Entity::EQS::Message MongoEnsRepository::sendMessage(const std::string &messageId, const std::string &ern, const std::string &queueErn, const std::string &body, const std::map<std::string, Entity::COM::Variant> &attributes,
    ...
    void MongoEnsRepository::purgeQueue(const std::string &queueErn) {
    ...
    void MongoEnsRepository::purgeAllQueues(const std::string &region, const std::string &accountId) {
    ...
    long MongoEnsRepository::countMessages(const std::string &queueErn) const {

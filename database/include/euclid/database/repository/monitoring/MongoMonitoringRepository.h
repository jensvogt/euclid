...
namespace Euclid::Database {
     ...
     */
    class MongoMonitoringRepository final : public IMonitoringRepository {
    ...
    public:
         ...
         */
        static MongoMonitoringRepository &instance() {
            static MongoMonitoringRepository monitoringDatabase;
